...
if __name__ == '__main__':
  ...
  parser.add_argument('--reg_lambda', type=float, default= 10000, help='regularization coeff for adaptive invariant learning')
  parser.add_argument('--reg_lambda_2', type=float, default= 100, help='second regularization coeff for adaptive invariant learning')
